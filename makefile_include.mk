...
LTC_CFLAGS += -Wno-missing-field-initializers -Wno-missing-braces -Wno-cast-align
endif
...
OBJECTS=src/ciphers/aes/aes.o src/ciphers/aes/aes_enc.o src/ciphers/aes/aesni.o src/ciphers/anubis.o \
...
src/ciphers/safer/saferp.o src/ciphers/serpent.o src/ciphers/skipjack.o src/ciphers/tea.o \
